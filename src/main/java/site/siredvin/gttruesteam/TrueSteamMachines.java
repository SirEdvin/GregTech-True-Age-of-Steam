...
public class TrueSteamMachines {
    ...
    public static final Pair<MachineDefinition, MachineDefinition> SOLID = registerSteamMachine("solid", ExpandedSteamSolidBoilerMachine::new, (isHigherPressure, builder) -> builder
            ...
            .model(createWorkableSteamHullMachineModel(isHigherPressure, GTCEu.id("block/generators/boiler/coal")))
            .tooltips(Component.translatable("gtceu.universal.tooltip.produces_fluid",
                    (ConfigHolder.INSTANCE.machines.smallBoilers.hpSolidBoilerBaseOutput * (isHigherPressure ? 2.0: 1.5) *
                            FluidType.BUCKET_VOLUME / 20000)))
            .register());

    public static final Pair<MachineDefinition, MachineDefinition> LIQUID = registerSteamMachine("liquid", ExpandedSteamLiquidBoilerMachine::new, (isHigherPressure, builder) -> builder
            .recipeType(GTRecipeTypes.STEAM_BOILER_RECIPES)
            .rotationState(RotationState.ALL)
            .recipeModifier(ExpandedSteamLiquidBoilerMachine::recipeModifier)
            .modelProperty(GTMachineModelProperties.RECIPE_LOGIC_STATUS, RecipeLogic.Status.IDLE)
            .model(createWorkableSteamHullMachineModel(isHigherPressure, GTCEu.id("block/generators/boiler/lava")))
            .tooltips(Component.translatable("gtceu.universal.tooltip.produces_fluid",
                    (ConfigHolder.INSTANCE.machines.smallBoilers.hpLiquidBoilerBaseOutput * (isHigherPressure ? 2.0: 1.5) *
                            FluidType.BUCKET_VOLUME / 20000)))
            .register());

    public static final Pair<MachineDefinition, MachineDefinition> SOLAR = registerSteamMachine("solar", ExpandedSteamSolarBoilerMachine::new, (isHigherPressure, builder) -> builder
            .recipeType(GTRecipeTypes.STEAM_BOILER_RECIPES)
            .rotationState(RotationState.NON_Y_AXIS)
            .recipeModifier(ExpandedSteamSolarBoilerMachine::recipeModifier)
            .modelProperty(GTMachineModelProperties.RECIPE_LOGIC_STATUS, RecipeLogic.Status.IDLE)
            .model(createWorkableSteamHullMachineModel(isHigherPressure, GTCEu.id("block/generators/boiler/solar")))
            .tooltips(Component.translatable("gtceu.universal.tooltip.produces_fluid",
                    (ConfigHolder.INSTANCE.machines.smallBoilers.hpSolarBoilerBaseOutput * (isHigherPressure ? 2.0: 1.5) *
                            FluidType.BUCKET_VOLUME / 20000)))
            .register());
    ...
    public static MachineBuilder.ModelInitializer createWorkableSteamHullMachineModel(boolean higherPressure, ResourceLocation overlayDir) {
