...
public class TrueSteamLang {
    ...
    public static String COIL_COOLING_CAPACITY_KEY = Util.makeDescriptionId("tooltip", GTTrueSteam.id("cooling_coils_capacity"));
    public static String COOLING_CAPACITY_MESSAGE_KEY = Util.makeDescriptionId("message", GTTrueSteam.id("cooling_capacity"));
    public static String COATING_CHARGES_MESSAGE_KEY = Util.makeDescriptionId("message", GTTrueSteam.id("coating_charges"));
    ...
    public static MutableComponent COATING_FLUID_CONDITION = GTTrueSteam.REGISTRATE.addLang("condition", GTTrueSteam.id("coating_fluid"), "Coating fluid:");
    public static MutableComponent COOLING_CAPACITY_CONDITION = GTTrueSteam.REGISTRATE.addRawLang(COOLING_REQUIRED_KEY, "Cooling required: %d");

    public static MutableComponent COATING_CHARGES = GTTrueSteam.REGISTRATE.addLang("tooltip", GTTrueSteam.id("coating_charges"), "Coating charges: ");
    public static MutableComponent COIL_ERROR = GTTrueSteam.REGISTRATE.addRawLang(COIL_ERROR_KEY, "All cooling coils should be the same");
    public static MutableComponent COIL_COOLING_CAPACITY = GTTrueSteam.REGISTRATE.addRawLang(COIL_COOLING_CAPACITY_KEY, "§bBase Cooling Capacity: §f%d ηK");
    public static MutableComponent CHARGING_CYCLES = GTTrueSteam.REGISTRATE.addRawLang(CHARGING_CYCLES_KEY, "Charging for %d cycles");
    public static MutableComponent OVERHEATABLE = GTTrueSteam.REGISTRATE.addLang("tooltip", GTTrueSteam.id("overheatable"), "§cOverheat§f-able");
    public static MutableComponent COOLING_CONSUMED = GTTrueSteam.REGISTRATE.addRawLang(COOLING_CONSUMED_KEY, "Cooling consumed: %d");
    ...
    public static MutableComponent COOLING_CAPACITY_MESSAGE = GTTrueSteam.REGISTRATE.addRawLang(COOLING_CAPACITY_MESSAGE_KEY, "Current cooling capacity: %d");
    public static MutableComponent COATING_CHARGES_MESSAGE = GTTrueSteam.REGISTRATE.addRawLang(COATING_CHARGES_MESSAGE_KEY, "Left coating charges: %d");
