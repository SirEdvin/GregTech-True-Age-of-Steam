...
public class ExpandedSteamSolidBoilerMachine extends SteamSolidBoilerMachine {
    ...
    protected long getBaseSteamOutput() {
        return isHigherPressure ? ConfigHolder.INSTANCE.machines.smallBoilers.hpSolidBoilerBaseOutput * 2L :
                (long) (ConfigHolder.INSTANCE.machines.smallBoilers.hpSolidBoilerBaseOutput * 1.5);
    }
